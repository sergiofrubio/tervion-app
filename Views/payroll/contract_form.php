                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="sm:col-span-2 pt-2 border-t border-gray-100/50 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" name="email" required placeholder="empleado@clinicavelion.com" class="block w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-primary-600 sm:text-sm py-2.5 bg-white transition-all">
                        </div>
                        <div>

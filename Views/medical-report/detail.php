...
<div class="max-w-4xl mx-auto animate-fade-in-up">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= PROJECT_ROOT ?>/pacientes/detalle?usuario_id=<?= $report['paciente_id'] ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-primary-600 transition-colors px-3">

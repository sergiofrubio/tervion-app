...
<div class="max-w-4xl mx-auto animate-fade-in-up">
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="<?= PROJECT_ROOT ?>/pacientes/detalle?usuario_id=<?= $paciente['usuario_id'] ?>" onclick="if (history.length > 1) { history.back(); return false; }" class="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-primary-600 transition-colors">
